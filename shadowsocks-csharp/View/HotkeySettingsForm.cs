...
namespace Shadowsocks.View
{
    public partial class HotkeySettingsForm : Form
    {
        ...
        private void RegHotkeysAtStartupCheckBox_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void RegHotkeysAtStartupLabel_Click(object sender, EventArgs e)
        {
